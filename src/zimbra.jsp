...
<%!
    private static final Logger				_log				= Logger.getLogger( "org_metadata_zimbra" );
%>
...
<%
    ...
    _log.error( "org_metadata_zimbra.zimbra.jsp: src=" + src );
    _log.error( "org_metadata_zimbra.zimbra.jsp: alfUrl=" + alfUrl );
    _log.error( "org_metadata_zimbra.zimbra.jsp: path=" + path );
    _log.error( "org_metadata_zimbra.zimbra.jsp: desc=" + desc );
    _log.error( "org_metadata_zimbra.zimbra.jsp: title=" + title );
    _log.error( "org_metadata_zimbra.zimbra.jsp: tags=" + tags );
    _log.error( "org_metadata_zimbra.zimbra.jsp: ticket=" + ticket );
    _log.error( "org_metadata_zimbra.zimbra.jsp: name=" + name );
